                        ...
                        <div class="w-screen max-w-md">
                            <div class="h-full  flex flex-col bg-white shadow-xl overflow-y-scroll">
                                ...
                                <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
                                    ...
                                    <div class="mt-6">
                                        <Link to="/payment" class="flex justify-center items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">Checkout</Link>
                                    </div>
                                    <div class="mt-6 flex justify-center text-sm text-center text-gray-500">
                                        <p>
                                            or <button type="button" class="text-indigo-600 font-medium hover:text-indigo-500">
                                                <a href="gftft" class="product">
                                                    Continue Shopping
                                                </a>
                                                <span aria-hidden="false"> &rarr;</span></button>
                                        </p>
                                    </div>
                                </div>
                            </div>
