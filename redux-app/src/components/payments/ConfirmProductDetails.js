...
function ConfirmProductDetails({ product }) {
    console.log(product)
    return (
        <div>
            <section class="text-gray-600 body-font ">
                <div class="container px-5 py-24 mx-auto ">
                    <h1 style={{ fontSize: "35px", color: "indigo", marginBottom: "20px" }}>Your Item   {product.length} Items</h1>
...
export default ConfirmProductDetails
